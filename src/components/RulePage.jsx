  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <li>本系統可能蒐集您於使用過程中提供之個人資料（如姓名、電子郵件帳號、班級、座號、學號、電話、密碼、IP 位址等），僅用於系統管理、使用者識別與功能提供，不會用於其他未經授權之用途。</li>
        <li>您有權依《個人資料保護法》行使查詢、閱覽、補充、更正、停止蒐集、處理或使用及刪除等權利，請聯繫系統管理員辦理。</li>
        <li>本系統將採取合理技術與管理措施，保護您的個人資料安全，防止未經授權之存取、洩漏或竄改。</li>
        <li>如有未經授權之存取、洩漏或竄改您的個人資料，本系統不負任何責任，使用者應自行向行為人究責。</li>
        </ul>
        <h3 style={{ color: "#000000ff", marginBottom: "24px" }}>
            二、使用者責任
        </h3>
        <ul style={{ color: "#000000ff", marginBottom: "24px" }}>
        <li>您應保證所提供之使用者內容不違反中華民國法律、臺北市立建國高級中學校規及臺北市立建國高級中學班聯會內法。</li>
        <li>您不得利用本系統從事任何違法、不當或侵害他人權益之行為。</li>
        <li>您應妥善保管您的帳號及密碼，對於任何經由您的帳號所進行之行為，您應負完全責任。</li>
        <li>若您違反本條款，您應自行承擔一切法律責任，並賠償本系統及第三人因此所受之損害。</li>
        </ul>
        <h3 style={{ color: "#000000ff", marginBottom: "24px" }}>
            三、平台責任免除與內容管理
        </h3>
        <ul style={{ color: "#000000ff", marginBottom: "24px" }}>
        <li>本系統僅提供一個線上訂購平台，不對使用者所發布之內容（如商品資訊、訂單資訊等）負任何保證責任。</li>
        <li>對於任何因使用者內容所生之錯誤、遺漏、違法事項或損害，本系統不負任何責任。</li>
